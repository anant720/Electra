...
export default function LoginPage() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      ...
      const { onboardingComplete: done } = useAuthStore.getState();
        ...
        >
          ...
          <div className="flex flex-col items-center mb-8 gap-3">
            ...
            <div className="text-center">
              ...
              <p className="text-white/40 text-sm mt-1">Sign in to ELECTRA</p>
            </div>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <label htmlFor="login-email" className="block text-sm font-medium mb-1.5" style={{ color: 'rgba(255,255,255,0.6)' }}>
                Email address
              </label>
              <input
                id="login-email"
                ...
                className="w-full px-4 py-3 rounded-xl text-white text-sm transition-all duration-150 focus:outline-none"
                style={{
            ...
            <div>
              <label htmlFor="login-password" className="block text-sm font-medium mb-1.5" style={{ color: 'rgba(255,255,255,0.6)' }}>
                Password
              </label>
              <input
                id="login-password"
          ...
          <p className="text-center text-sm mt-6" style={{ color: 'rgba(255,255,255,0.35)' }}>
            No account?{' '}
            <Link href="/auth/signup" className="font-semibold hover:underline" style={{ color: '#60A5FA' }}>
              Create one free
            </Link>
          </p>
        </div>
